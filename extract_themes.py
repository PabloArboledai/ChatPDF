...
def top_keywords_for_cluster(texts, top_n=5):
    ...
    # scikit-learn may not accept 'spanish' as stop_words in some versions,
    # so we leave stop_words=None (no removal) to avoid errors.
    vect = TfidfVectorizer(stop_words=None, max_features=5000, ngram_range=(1,2))
